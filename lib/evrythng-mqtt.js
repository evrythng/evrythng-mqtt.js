...
(function (root, factory) {
  ...
  // - _**apiUrl**: EVRYTHNG URL for the MQTT server_
  ...
  function _isClientConnected(scope) {
    return scope.mqttClient && scope.mqttClient.connected === true;
  }
  ...
  EVTMqttPlugin.$inject = ['resource', 'entity/action', 'utils'];
